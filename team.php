            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item text-center p-4">
                        <img class="img-fluid border rounded-circle w-75 p-2 mb-4" src="https://avatars.githubusercontent.com/u/178119192?v=4" alt="">
                        <div class="team-text">
                            <div class="team-title">
                                <h5>Yash Digvijay Singh</h5>
                                <span>Founder</span>
                            </div>
